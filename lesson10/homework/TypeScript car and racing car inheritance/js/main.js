...
let jaguarCar = new Car("Jaguar", "Jaguar F-PACE", "Silver", 3800);
let peugeotRacingCar = new RaceCar("Peugeot", "908 HDi FAP", "Blue", 4000, 498, 0);
jaguarCar.displayDetails(document.getElementById("car"));
peugeotRacingCar.displayDetails(document.getElementById("raceCar"));
function verifySetAndGet(divId, getResult, expectedResult, expectFailure) {
    const equalsResult = (getResult === expectedResult);
