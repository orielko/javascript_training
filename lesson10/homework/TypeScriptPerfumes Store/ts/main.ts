...
let gucciPerfume:Perfume=new Perfume("Gucci Guilty","Guccig",Gender.Male,150,333);
let creedPerfume:Perfume=new Perfume("Creed Aventus by Creed","Creed",Gender.Male,100,1044);
let ronEmployee:Employee=new Employee("Ron","Harper","Ohio",220000000);
let danEmployee:Employee=new Employee("Dan","Majerle","Arizona",27885000);
